...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Signature.document_title'
        db.add_column(u'django_docusign_demo_signature', 'document_title',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Signature.document_title'
        db.delete_column(u'django_docusign_demo_signature', 'document_title')
